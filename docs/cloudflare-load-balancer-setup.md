...
Pool `zerowaste-primary`: origin `app-01`, address `137.184.42.51`, port 443, enabled, monitor above. Pool `zerowaste-secondary`: origin `app-02`, address `134.122.23.135`, port 443, enabled, same monitor.
