...
assert.match(comments, /keyboardLayoutRevision/);
...
assert.match(routeNavigation, /paddingTop: Math\.max\(insets\.top \+ 8, 16\)/);
assert.match(routeNavigation, /paddingBottom: Math\.max\(insets\.bottom \+ 8, 16\)/);
assert.match(mapScreen, /Mapbox\.StyleURL\.Street/);
