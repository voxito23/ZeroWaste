...
class UserController extends Controller
{
    ...
    {
        $rules = [
            'nombre' => ['required', 'string', 'min:5', 'max:30', 'regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ0-9\s]+$/'],
            'email' => 'required|email|max:100|unique:usuarios',
            'password' => 'required|string|min:6',
            'ubicacion' => 'required|string|min:5|max:30',
            'titulo_perfil' => 'required|string',
            'biografia' => 'nullable|string|max:100',
            'foto_perfil' => 'required|image|max:256000',
        ];
        ...
        $messages = [
            ...
            'foto_perfil.required' => 'Debes subir una fotografía de perfil.',
