        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="descripcion" rows="4" required maxlength="500" class="w-full bg-gray-50/50 dark:bg-[#064E3B]/10 border border-gray-200 dark:border-emerald-800/30 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-11 p-3.5 transition-all duration-300 hover:bg-white dark:hover:bg-[#064E3B]/20">{{ $campaign->descripcion }}</textarea>
                </div>
                <div class="flex justify-between items-center mt-1">
