...
@section('title', 'Crear Evento o Jornada')
@section('page_title', 'Crear Nuevo Evento o Jornada')
...
<div class="bg-white/80 dark:bg-[#0B1F18]/80 backdrop-blur-xl rounded-[2rem] p-8 lg:p-10 shadow-2xl border border-white/50 dark:border-emerald-800/30 relative overflow-hidden group max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-10 relative z-10 border-b border-gray-100 dark:border-emerald-800/30 pb-6">
        ...
        <div>
            <h2 class="text-3xl font-black text-[#064E3B] dark:text-white tracking-tight">Nuevo Evento o Jornada</h2>
            <p class="text-gray-500 dark:text-emerald-200/70 text-sm font-medium mt-1">Registra información sobre próximos eventos y jornadas comunitarias.</p>
        </div>
    </div>
    <form id="customForm" novalidate action="{{ route('eventos.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6 relative z-10">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="descripcion" rows="4" required maxlength="500" placeholder="Detalles del evento..." class="w-full bg-gray-50/50 dark:bg-[#064E3B]/10 border border-gray-200 dark:border-emerald-800/30 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-11 p-3.5 transition-all duration-300 hover:bg-white dark:hover:bg-[#064E3B]/20"></textarea>
                </div>
                <div class="flex justify-between items-center mt-1">
        ...
        <div class="flex justify-between items-center mt-6 pt-6 border-t border-gray-100 dark:border-emerald-800/30">
            ...
            <button type="submit" class="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-emerald-500/30 transition-all duration-300 hover:-translate-y-1 flex items-center gap-2">
                <span class="material-symbols-outlined text-lg">save</span> Guardar Evento
            </button>
        </div>
    </form>
</div>
