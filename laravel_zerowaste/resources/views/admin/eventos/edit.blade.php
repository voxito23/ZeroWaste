        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="titulo" id="input-titulo" value="{{ $evento->titulo }}" required maxlength="30" class="w-full bg-gray-50/50 dark:bg-[#064E3B]/10 border border-gray-200 dark:border-emerald-800/30 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-11 p-3.5 transition-all duration-300 hover:bg-white dark:hover:bg-[#064E3B]/20">
                </div>
                <div class="flex justify-between items-center mt-1">
                    <span id="err-titulo" class="hidden text-red-500 text-xs font-medium ml-1"></span>
                    <span id="counter-titulo" class="text-xs font-semibold text-gray-400 dark:text-emerald-500/50 ml-auto">{{ strlen($evento->titulo) }}/30</span>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="descripcion" rows="4" required maxlength="500" class="w-full bg-gray-50/50 dark:bg-[#064E3B]/10 border border-gray-200 dark:border-emerald-800/30 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-11 p-3.5 transition-all duration-300 hover:bg-white dark:hover:bg-[#064E3B]/20">{{ $evento->descripcion }}</textarea>
                </div>
                <div class="flex justify-between items-center mt-1">
                    <span id="err-descripcion" class="hidden text-red-500 text-xs font-medium ml-1"></span>
                    <span id="counter-descripcion" class="text-xs font-semibold text-gray-400 dark:text-emerald-500/50 ml-auto">{{ strlen($evento->descripcion) }}/500</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="lugar" id="input-lugar" value="{{ $evento->lugar }}" maxlength="30" class="w-full bg-gray-50/50 dark:bg-[#064E3B]/10 border border-gray-200 dark:border-emerald-800/30 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-11 p-3.5 transition-all duration-300 hover:bg-white dark:hover:bg-[#064E3B]/20">
                    </div>
                    <div class="flex justify-between items-center mt-1">
                        <span id="err-lugar" class="hidden text-red-500 text-xs font-medium ml-1"></span>
                        <span id="counter-lugar" class="text-xs font-semibold text-gray-400 dark:text-emerald-500/50 ml-auto">{{ strlen($evento->lugar) }}/30</span>
                    </div>
                </div>
                <div>
            ...
            <div>
                ...
                <div class="mb-3 flex items-center gap-3 bg-gray-50 dark:bg-[#0B1F18] p-3 rounded-xl border border-gray-200 dark:border-emerald-800/30">
                    <img src="{{ $evento->cover_url }}" alt="Imagen actual" class="h-16 w-24 object-cover rounded-lg border border-emerald-200 dark:border-emerald-700/50" onerror="this.style.display='none'">
